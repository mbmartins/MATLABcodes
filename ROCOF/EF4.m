function [f1,f2,F,f_u,ri] = EF4(Psi_noise, az, Fs, tau_n)    
% EF4
% 1 - amostragem ideal
% 2 - Psi obtido pela fase do sinal analitico
% 3 - f_i[n] obtida pelo gradient de Psi filtrado por PATV (d=1, lambda
% para minimizar o FE de fr medio, Psi = p+x (filtro somente do ruido)
...
%Estimador EF4 
    ...
    d = 1; 
    lambda = 6.5; %%<- foi otimizado para minizar FE na definicao de F medio
    Nit = 20; 
...
%     end
    ...
    f_u=gradient(Psi_u)*Fs/(2*pi);% Hilbert estimate of the instantaneous frequency of z
