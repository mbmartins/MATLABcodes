function [filename] = MC_HLM4_taufixo(MCruns, SNR, Fs, hm, ha, phi0,run,ti)
% Estimation of Sincrophasors with discontinuities
% using MATLAB optimization toolbox 
% ATENCAO: mantendo tau fixo e frequencia fixa
%signal generation
F0 = 50; %Hz
F1 = 50; %Hz
%Fs = 5000; %Hz
...
filename = "Cap4_LM\resultadosMC\MC_LM_taufixo";
filename = filename+"MCruns"+MCruns+"Fs"+Fs+"SNR"+floor(SNR)+"ha"+ha+"hm"+(hm*100)+"phi0"+phi0
save(filename)
