function [tau_error,FE, dmax] = PATV_HE_estimator_2peaks(SNR,KxS,KaS,Ps,tau1,SAG_cycles,lambda_a,lambda_theta)
...
th_a_i = 1.0e-3; th_fi = 1.0e-3; %thresholds for detection
%km = 2e7;
%kf = 100e9;
