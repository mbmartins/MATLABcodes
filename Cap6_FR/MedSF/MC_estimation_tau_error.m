function [Fraw,f1raw,f2raw,kfraw] = MC_estimation_tau_error(MC_iterations,F0,F1,Fs,phi_n,NCycles,tau1,tau_error,tau2,SNR,KaS, KxS,KfS,nbits)
% OBS: SOMENTE PARA SALTOS DE FREQUENCIA
%considera tau_n1 com erro de estimação

T = NCycles/F0;
NSamples = floor(NCycles*Fs/F0);
tau_n1 = floor(tau1*NSamples)+tau_error; %considera tau_n1 com erro de estimação
...
for k = 1:MC_iterations
    ...
    [f1_est1(k),f2_est1(k),F_est1(k),fu1,ri1] = EF1(f_i,tau_n1); %considera tau_n1 com erro de estimação
