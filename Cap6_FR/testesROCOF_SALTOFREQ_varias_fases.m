...
plot(phi_n,ROCOF_est,'.-',phi_n,ROCOF_est_comp,'.-',phi_n,ROCOF_estDF2,phi_n,ROCOF_vec,'k')
title('ROCOF de rede estimada em função de \phi_0 para salto de fase de 10 graus')
xlabel('\phi_0 [°]'); 
ylabel('ROCOF [Hz/s]')
legend('ROCOF sem compensação','ROCOF com compensação','ROCOF DF2','limites do ERAC')
